<%-- 
    Document   : FomasPagoAutentificar
    Created on : Jul 20, 2014, 1:09:15 PM
    Author     : User
--%>
...
<body>
        <center>
            <a class='modalbox' href='#ingresar'><img SRC='Imagen/Autentificar.png'></a>
             <div id="ingresar">
                <h2>Nuevo</h2>
                <form id="ingresarform" name="ingresarform" action="AutentificarFormasPagoServlet" method="post" >
