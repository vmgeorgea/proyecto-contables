 ...
 * @author User
 */
@WebServlet(name = "AsientoIngresarServlet", urlPatterns = {"/AsientoIngresarServlet"})
public class AsientoIngresarServlet extends HttpServlet {
...
AsientoDAO ud = new AsientoDAO();
    ...
    try {
        ...
        Logger.getLogger(AsientoIngresarServlet.class.getName()).log(Level.SEVERE, null, ex);
