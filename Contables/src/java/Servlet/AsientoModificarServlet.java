 ...
 * @author User
 */
@WebServlet(name = "AsientoModificarServlet", urlPatterns = {"/AsientoModificarServlet"})
public class AsientoModificarServlet extends HttpServlet {
...
AsientoDAO ud = new AsientoDAO();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Logger.getLogger(AsientoModificarServlet.class.getName()).log(Level.SEVERE, null, ex);
