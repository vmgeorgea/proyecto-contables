...
<html>
    ...
    <body>
        ...
        <li><a href="IVAAutentificar.jsp" target="contenidoadministracion">IVA</a></li>
        <li><a href="#"> </a></li>
        <li><a href="FomasPagoAutentificar.jsp" target="contenidoadministracion">Formas de Pago</a></li>
        <li><a href="#"> </a></li>
        <li><a href="DocumentoAutentificar.jsp" target="contenidoadministracion">Documento</a></li>
        <li><a href="#"> </a></li>        
        </ul>
        </div>
