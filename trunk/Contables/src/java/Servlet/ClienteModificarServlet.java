 ...
 * @author User
 */
@WebServlet(name = "ClienteModificarServlet", urlPatterns = {"/ClienteModificarServlet"})
...
ClienteDAO ud = new ClienteDAO();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ClienteClass u=new ClienteClass(idCliente, cedula, nombre, apellido, direccion, telefono, tipo);
        ...
        Logger.getLogger(ClienteModificarServlet.class.getName()).log(Level.SEVERE, null, ex);
