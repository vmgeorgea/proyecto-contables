 ...
 * @author User
 */
@WebServlet(name = "FormaspagoIngresarServlet", urlPatterns = {"/FormaspagoIngresarServlet"})
public class FormaspagoIngresarServlet extends HttpServlet {
...
FormaspagoDAO ud = new FormaspagoDAO();
    ...
    try {
        ...
        Logger.getLogger(FormaspagoIngresarServlet.class.getName()).log(Level.SEVERE, null, ex);
