 ...
 * @author User
 */
@WebServlet(name = "ProveedorIngresarServlet", urlPatterns = {"/ProveedorIngresarServlet"})
public class ProveedorIngresarServlet extends HttpServlet {
...
ProveedorDAO ud = new ProveedorDAO();
    ...
    try {
        ...
        ProveedorClass u=new ProveedorClass(identificacionProveedor, nombreProveedor, direccionProveedor, telefonoProveedor, autorizacionProveedor, fechaCaducidadAutorizacionProveedor, tipoProveedor);
        ...
        Logger.getLogger(ProveedorIngresarServlet.class.getName()).log(Level.SEVERE, null, ex);
