 ...
 * @author User
 */
@WebServlet(name = "ClienteIngresarServlet", urlPatterns = {"/ClienteIngresarServlet"})
public class ClienteIngresarServlet extends HttpServlet {
...
ClienteDAO ud = new ClienteDAO();
    ...
    try {
        ...
        Logger.getLogger(ClienteIngresarServlet.class.getName()).log(Level.SEVERE, null, ex);
