 ...
 * @author User
 */
@WebServlet(name = "IVAModificarServlet", urlPatterns = {"/IVAModificarServlet"})
public class IVAModificarServlet extends HttpServlet {
...
IVADAO ud = new IVADAO();
    ...
    try {
        ...
        Logger.getLogger(IVAModificarServlet.class.getName()).log(Level.SEVERE, null, ex);
