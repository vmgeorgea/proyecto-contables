 ...
 * @author User
 */
@WebServlet(name = "TipoModificarServlet", urlPatterns = {"/TipoModificarServlet"})
public class TipoModificarServlet extends HttpServlet {
...
TipoDAO ud = new TipoDAO();
    ...
    try {
        ...
        Logger.getLogger(TipoModificarServlet.class.getName()).log(Level.SEVERE, null, ex);
