 ...
 * @author User
 */
@WebServlet(name = "AsientoEliminarServlet", urlPatterns = {"/AsientoEliminarServlet"})
public class AsientoEliminarServlet extends HttpServlet {
...
AsientoDAO ud = new AsientoDAO();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
    try {
        AsientoClass u=new AsientoClass();
        u.setIdAsiento(request.getParameter("idAsiento"));
        ...
        Logger.getLogger(AsientoEliminarServlet.class.getName()).log(Level.SEVERE, null, ex);
